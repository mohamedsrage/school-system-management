                                ...
                                <div class="table-responsive">
                                    <table id="datatable" class="table  table-hover table-sm table-bordered p-0"
                                        ...
                                        @foreach($promotions as $promotion)
                                            <tr>
                                                <td>{{ $loop->index+1 }}</td>
                                                <td>{{is_null($promotion->student) ? '' : $promotion->student->name}}</td>
                                                <td>{{is_null($promotion->f_grade) ? '' : $promotion->f_grade->Name}}</td>
                                                <td>{{$promotion->academic_year}}</td>
                                                <td>{{is_null($promotion->f_classroom) ? '' : $promotion->f_classroom->Name_Class}}</td>
                                                <td>{{is_null($promotion->f_section) ? '' : $promotion->f_section->Name_Section}}</td>
                                                <td>{{is_null($promotion->t_grade) ? '' : $promotion->t_grade->Name}}</td>
                                                <td>{{$promotion->academic_year_new}}</td>
                                                <td>{{is_null($promotion->t_classroom) ? '' : $promotion->t_classroom->Name_Class}}</td>
                                                <td>{{is_null($promotion->t_section) ? '' : $promotion->t_section->Name_Section}}</td>
                                                <td>
