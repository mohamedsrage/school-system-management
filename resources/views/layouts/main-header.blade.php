        ...
        <li class="nav-item dropdown mr-30">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                @if(auth('student')->check())
                    <form method="GET" action="{{ route('auth-logout','student') }}">
                        @elseif(auth('teacher')->check())
                            <form method="GET" action="{{ route('auth-logout','teacher') }}">
                                @elseif(auth('parent')->check())
                                    <form method="GET" action="{{ route('auth-logout','parent') }}">
                                        @else
                                            <form method="GET" action="{{ route('auth-logout','web') }}">
                                                @endif
